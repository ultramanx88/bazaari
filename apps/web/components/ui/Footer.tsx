        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/food-delivery" className="text-gray-300 hover:text-white">Food Delivery</Link></li>
              <li><Link href="/hotels" className="text-gray-300 hover:text-white">Hotels & Booking</Link></li>
              <li><Link href="/spa-massage" className="text-gray-300 hover:text-white">Spa & Massage</Link></li>
              <li><Link href="/visa-services" className="text-gray-300 hover:text-white">Visa Services</Link></li>
              <li><Link href="/healthcare" className="text-gray-300 hover:text-white">Healthcare</Link></li>
              <li><Link href="/real-estate" className="text-gray-300 hover:text-white">Real Estate</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/partner" className="text-gray-300 hover:text-white">Become a Partner</Link></li>
            </ul>
          </div>
        </div>
      </div>
